...
You can install the development version of galahr from [GitHub](https://github.com/) with:
...
Note that rendering is slow with the latest version of `plotly` and we recommend using version 4.8 with the `galahr` package. You can install this version with:
